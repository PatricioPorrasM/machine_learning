...
```{python}
#| label: EDA_density_heatmap
#| fig-cap: "Heatmap de Densidad: Longitud del Tweet vs. Score de Toxicidad"
...
#| fig-cap: "Matriz de Confusión (Clasificación)"
...
#| fig-cap: "Curva ROC (Clasificación)"
