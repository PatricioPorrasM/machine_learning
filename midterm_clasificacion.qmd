...
En este cuaderno, realizaremos un análisis de clasificación para predecir el índice de estrés académico de los estudiantes utilizando un modelo de **Regresión Logística**. Siguiendo las buenas prácticas de Machine Learning, implementaremos el modelo dentro de un `Pipeline` de Scikit-Learn para estandarizar los datos y entrenar el modelo de forma secuencial y ordenada.

El objetivo es seguir un proceso estructurado:
1.  Carga y limpieza de datos.
2.  División de los datos para entrenamiento y prueba.
3.  Definición y entrenamiento de un pipeline.
4.  Predicción sobre datos nuevos.
